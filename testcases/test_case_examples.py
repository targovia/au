import pytest
from pages.herokuapp_page import Herokuapp
...
class TestNet():
    ...
    def class_setup(self):
        self.homePage = Herokuapp(self.driver)

    def test_clickABtestLink(self):
        self.homePage.clickABTestinglink()

    def test_clickADDREmove(self):
        self.homePage.clickADDREMOVElink()

    def test_clickBrokenImg(self):
        self.homePage.clickBrokenImg()
...
#         text = driver.findElement(By.XPATH, ("//p[contains(text(), 'Congratulations!')]"))
...
#
#         }
#         Arrays.stream(table).forEach((k) -> {
#             Arrays.stream(k).forEach((j) -> System.out.print(j + " "));
#             System.out.println();
#         });
#         System.out.println(tableColumnsCount);
...
#
#     @Test
#     void floatingMenu() throws InterruptedException {
